...
# Defining administration_dashboard class
class administration_dashboard(object):
    ...
    def obtain_booking_information(self):
        pointer.execute(
            'SELECT TravelID, PickupDate, PickupTime, PickupAddress, DropAddress, PaymentInformation,'
    ...
    # Setting up the UI Admin Dashboard
    ...
    def update_text(self, mainPage):
        ...
        self.booking_label.setText(update("mainPage",
                                          "<html><head/><body><p><span style =\"font-weight:550;"
                                                    "font-size:20pt;\">Admin Booking</span></p></body></html>"))
